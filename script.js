...
{
    let name = "Muhammad Ahsan Azeem";
document.getElementById("altnam").onclick=alert(name)
}

// Alert Number 
document.getElementById("altnum").onclick=function()
{
    document.getElementById("altnum").onclick=alert("WMA-223008")
}
